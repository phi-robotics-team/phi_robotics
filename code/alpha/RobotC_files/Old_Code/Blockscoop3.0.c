...
#pragma config(Motor,  mtr_S1_C1_1,     R_Motor,       tmotorTetrix, openLoop)
...
#pragma config(Motor,  mtr_S1_C3_1,     Flag,          tmotorTetrix, openLoop, reversed, encoder)
