...
#pragma config(Motor,  mtr_S1_C1_1,     L_B,           tmotorTetrix, openLoop, reversed)
#pragma config(Motor,  mtr_S1_C1_2,     R_B,           tmotorTetrix, openLoop, reversed)
...
task drive()
{
	...
	while (true)
	{
		...
		L_side_motor = Joy1Xmve + Joy1Ymve;
		R_side_motor = Joy1Xmve - Joy1Ymve;
		...
		motor[L_B] = -L_side_motor; //To Change the direction of the motor.
		motor[R_B] = -R_side_motor;
	}
}
