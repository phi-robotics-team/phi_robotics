...
#pragma config(Sensor, S2,     Ac,             sensorI2CHiTechnicAccel)
...
#pragma config(Servo,  srvo_S1_C4_4,    IRS_1,                tServoStandard)
...
task main()
{
  ...
  int z_axis = 0;
	...
	HTACreadAllAxes(Ac, x_axis, y_axis, z_axis);
	old_x_axis = x_axis;
