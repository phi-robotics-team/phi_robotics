...
#pragma config(Motor,  mtr_S1_C2_1,     rightDrive,    tmotorTetrix, PIDControl)
...
if(SensorValue[IR] == 5 && SensorValue [IR] < 120)
{
	Ultra_Seek(35,120);
	wait10Msec(55);
 ...
 if (SensorValue[IR] ==5 && SensorValue[SONAR_1] > 120)
{
	Move(4,75);
	wait10Msec(55);
