 ...
 */
    ...
    public class Oswin_Inside extends LinearOpMode {
    //This autonomy is an autonomy to park the robot in the floor goal. The start position is intended to be on the inside.
