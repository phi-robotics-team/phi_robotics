...
public class base_autonomy_11 extends LinearOpMode {
            ...
            switch (state) {
                case 0:
                   ...
                   // MoveEncoder(dist, power);
                    telemetry.addData("accel",Sensor.TYPE_LINEAR_ACCELERATION);
                    telemetry.addData("accel2",Sensor.TYPE_ACCELEROMETER);
                    wait1Msec(10000);
