...
#include "common.h"
#define clockIn 0x08 //B3
#define dataIn 0x04 //B2
#define clockOut 0x02 //B1
#define dataOut 0x01 //B0
bool scl = false;
bool sda = false;
byte buffer[10];
...
task main()
{
	...
	{
		updateAcceleration();
		writeDebugStreamLine("X Accel: %f", checkData());
		/*if (t)
			dataHi();
		else
			dataLo();
