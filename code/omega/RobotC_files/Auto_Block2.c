...
task main()
{
   ...
   while (nNxtButtonPressed != 3)
   {
     if (nNxtButtonPressed == 1)
  	 ...
  	 nxtDisplayBigTextLine(1, "%d, %s", distance, "inches");
  	 wait10Msec(30);
  }
  ...
  wait10Msec(30);
   ...
   while (nNxtButtonPressed != 3)
   {
     if (nNxtButtonPressed == 1)
  	 ...
  	 nxtDisplayBigTextLine(1, "%d, %s", turn, "deg. CW");
  	 wait10Msec(30);
  }
  ...
  while (nNxtButtonPressed != 3)
   {
     if (nNxtButtonPressed == 1)
  	 ...
  	 nxtDisplayBigTextLine(1, "%d, %s", distance2, "inches");
  	 wait10Msec(30);
  }
  ...
  Start();
   ...
   wait10Msec(10);
   Move(distance2, 100.0);    // drive forward distance inches
