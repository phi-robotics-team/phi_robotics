...
#pragma config(Motor,  mtr_S1_C2_2,  ...................
...
L_Front,       tmotorTetrix, openLoop, reversed)
...
task main()
{
   ...
   for (i=0;i<100;i++)
 {
  ...
  if(IRvalue==5)
   ...
   wait10Msec(10);
   Arm(-150.0, 70.0);    // arm down 195 degrees
   wait10Msec(100);

   Move(6.0, 70.0);    // drive forward 8 inches
   wait10Msec(10);
   ...
   /*Move(15.5, 70.0);    // drive forward 17- inches
   wait10Msec(10);
   ...
   wait10Msec(10);
   Arm(-210.0, 70.0);    // arm down 195 degrees
   wait10Msec(100);
   ...
   wait10Msec(10);*/
	...
	else if(IRvalue==3)
	{
	 ...
	 Move(45.0, 70.0);    // drive forward 50 inches
   wait10Msec(10);
   ...
   wait10Msec(10);
   Arm(-205.0, 70.0);    // arm down 195 degrees
   wait10Msec(100);
