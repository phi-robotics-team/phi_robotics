...
#pragma config(Motor,  mtr_S1_C1_2,     Arm_2,         tmotorTetrix, openLoop)
...
task main()
{
   ...
   /*Turn_gyro(-45.0);     // turn clockwise 45 degrees
   wait10Msec(10);

   Move(39.0, 70.0);    // drive forward 39 inches
   wait10Msec(10);

   Turn_gyro(-90.0);     // turn clockwise 90 degrees
   wait10Msec(10);

   Move(8.0, 70.0);    // drive forward 8 inches
   wait10Msec(10);
