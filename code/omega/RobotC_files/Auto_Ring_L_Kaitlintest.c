...
task main()
{
   ...
   Arm(192.0, 70.0);    // arm move 185 degrees
   wait10Msec(100);
   ...
   Move(-40.0, 70.0);    // drive backward 40 inches
   wait10Msec(10);

   Arm(-180.0, 100.0);    // arm move 40 degrees
   wait10Msec(5);

   Arm(270.0, 100.0);    // arm move 40 degrees
   wait10Msec(5);
   ...
   Arm(-145.0, 70.0);    // arm move 90 degrees
   wait10Msec(100);
   ...
   //Move(00.0, 70.0);    // drive forward 22 inches
   //wait10Msec(10);

   //Turn_gyro(00.0);     // turn counterclockwise 45 degrees
   //wait10Msec(10);

   //Arm(00.0, 70.0);    // arm move 197 degrees
   //wait10Msec(100);
   ...
   Arm(192.0, 70.0);    // arm move 197 degrees
   wait10Msec(100);
