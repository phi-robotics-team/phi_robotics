		...
		if(abs(joystick.joy1_y1) > deadband || abs(joystick.joy1_x1) > deadband)
		{
			if(abs(joystick.joy1_y1) > abs(joystick.joy1_x1))
			{
				...
				else
				{
					...
					motor[L_Front] =	-joystick.joy1_y1/2;
					motor[R_Front] =	-joystick.joy1_y1/2;
					motor[L_Rear] = -joystick.joy1_y1/2;
					motor[R_Rear] = -joystick.joy1_y1/2;
			...
			{
				motor[L_Front] =	-joystick.joy1_x1/2;
				motor[R_Front] =	joystick.joy1_x1/2;
				motor[L_Rear] = -joystick.joy1_x1/2;
				motor[R_Rear] = joystick.joy1_x1/2;
			}
