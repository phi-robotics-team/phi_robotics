...
task main()
{
 ...
 // waitForStart(); // Wait for the beginning of autonomous phase.
  ...
  while (true)
  {
  	wait10Msec(100); //Waits one second before start
  	motor[Left_drive] = 50; //Moves bot at power of 50
  	motor[Right_drive] = 50;
  	wait10Msec(200); //Moves bot at power for 2 seconds
  	motor[Left_drive] = 0; //Stops all robot movement
  	motor[Right_drive] = 0;
