...
task main()
{
   ...
   Move(48.0, 70.0);    // drive forward 27 inches
   wait10Msec(10);



   Turn(50.0);     // turn counterclockwise 90 degrees
   wait10Msec(10);

   Move(18.0, 70.0);    // drive forward 36 inches
   wait10Msec(10);

	 Arm_move( 50 );
		wait10Msec(10);
   //Turn(90.0);     // turn counterclockwise 90 degrees
   //wait10Msec(10);
   ...
   //wait10Msec(10);
		...
		//  Move(-12.0, 70.0);    // drive backward 12 inches
  		// wait10Msec(10);
