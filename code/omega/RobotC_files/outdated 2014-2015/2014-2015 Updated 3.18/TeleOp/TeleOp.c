...
task LameDrive()
{
	...
	while (true)
	{
		...
		//Shape the powers based on equation: y = (2/225)(x*abs(x))+(14/45)x
		shapedRight = 0.0088888888888889 * (rawLeft * abs(rawLeft)) + 0.3111111111111111 * rawLeft;
		shapedLeft = 0.0088888888888889 * (rawRight * abs(rawRight)) + 0.3111111111111111 * rawRight;
